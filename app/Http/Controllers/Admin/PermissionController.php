...
class PermissionController extends Controller
{
    ...
    {   
        ...
        return back() -> with('success', 'Permission added successul');
    ...
    public function update(Request $request, $id)
    {
       ...
       return back() -> with('success', 'Permission Updated successul');
    }
    ...
    public function destroy($id)
    {
        ...
        $delete -> delete();
        return back() -> with('success-main', 'Permission deleted successul');
